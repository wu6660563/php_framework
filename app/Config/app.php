...
return [
        ...
        'command' => [
            [
                ...
                'config' => [
                    'savepath' => DATA_PATH . '/logs/', //日志保存目录
                    'filesize' => 0, //文件分割大小
                    'filename' => 'paymanage_cmd-{Y}{m}{d}.log',
                ],
            ]
        ],
        ...
        'database' => [
            [
                ...
                'config' => [
                    'savepath' => DATA_PATH . '/logs/', //日志保存目录
                    'filesize' => 0, //文件分割大小
                    'filename' => 'paymanage_db-{Y}{m}{d}.log',
                ],
            ]
        ],
    ],
	...
	'database' => [
		...
		'default' => [
			...
			// 写库
			'write' => [
				'dsn' => "mysql:host=localhost;port=3306;dbname=paymanage;charset=utf8",
				'username' => 'root',
				'password' => '',
				'pconnect' => false,
			],
		...
		'payment' => [
				...
				// 写库
				'write' => [
						'dsn' => "mysql:host=localhost;port=3306;dbname=pay;charset=utf8",
						'username' => 'u_opencart',
						'password' => 'p_opencart_0701',
						'pconnect' => false,
				],
				// 读库，只允许配一个地址，如果是一主多从的话，建议使用haproxy或其他中间件做转发
				'read' => [
